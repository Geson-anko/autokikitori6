...
class Mel2Wave(pl.LightningModule):
    ...
    def __init__(self,lr:float=1e-4):
        ...
        # layers 
        init_conv = ConvNorm1d(init_ch,64,kernel_size=3,padding=1)
        upper_x13 = nn.Upsample(scale_factor=13)
        upper_x5 = nn.Upsample(scale_factor=5)
        conv0 = DilatedDepthUnit(64,256,7,4,divs=1,channel_attn=True)
        conv1 = DilatedDepthUnit(256,128,5,3,divs=4,channel_attn=True)
        conv2 = DilatedDepthUnit(128,32,5,3,divs=4)
